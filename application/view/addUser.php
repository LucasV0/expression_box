    ...
    <form id="inscr" action="../controller/inscriptionController.php" method="post">
        <div id="form2">
            <span>
                ...
                <input id="nom" type="nom" placeholder="nom" name="nom" required>
                ...
                <input type="date" id="dateNaissance" placeholder="Login" name="dateNaissance">
            </span>
            <span> </span>
            <span></span>
            <span>
                ...
                <input id="mdp" type="password" placeholder="Password" name="mdp" min="6" max="12" required>
